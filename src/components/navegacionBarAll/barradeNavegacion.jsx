        ...
        <>
            ...
            <nav className='horizontal-nav-bar'>
                <div className="nav-wrapper container horizontal-nav-bar-resp">
                    ...
                    <div className="user-name-container" style={{ color: '#212121', fontWeight: 'bold', height: 30, width: "400px", fontSize: '1.1rem', marginLeft: '16px' }}>
                        <span style={{ color: '#212121', fontWeight: 'bold',}}>
                            {dataApp.USER_NAME ? `Hola, ${dataApp.USER_NAME}` : ''}
                        </span>
                    </div>
